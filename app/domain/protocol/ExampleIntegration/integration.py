"""
Módulo de protocolo para integração externa de exemplo.

Este módulo define o protocolo (interface) para integrações externas
que requerem autenticação e envio de dados.

Classes:
    ExampleIntegrationProtocol: Protocolo para operações de integração
"""
